...
namespace Restoran.API.Controllers
{
    ...
    [ApiController]
    public class ServicesController(IGenericService<Service> _service, IMapper _mapper) : ControllerBase
    {
        [HttpGet]
        ...
        [HttpPost]
        public IActionResult Create(CreateServiceDto createServiceDto)
        {
